...
<div class="box">
    <!-- Box Head -->
    <div class="box-head">
        <h2>Add Reminder Kelas</h2>
    </div>
    <!-- End Box Head -->

    <form id="add-kelas" action="<?php echo base_url();?>admin/reminder/add_submit" method="post" >

        <!-- Form -->
        <div class="form">
            <p class="inline-field">
                <label>Tanggal Mulai</label>
                <input id="tanggal" type="text" class="field size2 validate[required]" name="tanggal" />
			 <input id="kelas_id" type="hidden"  name="kelas_id" value="<?php echo $kelas->kelas_id?>"/>
            </p>
            <p>
                <label>Catatan</label>
                <textarea class="field size1" rows="10" cols="30" name="keterangan"></textarea>
            </p>
        </div>
        <!-- End Form -->
