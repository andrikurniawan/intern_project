...
if( file_exists (APPPATH.'database/'.config_item('subclass_prefix').'DB_driver.php') )
	include_once(APPPATH.'database/'.config_item('subclass_prefix').'DB_driver.php');
if( class_exists(config_item('subclass_prefix').'DB_driver')) {
	if(config_item('subclass_prefix') !== 'MY_')
		eval('class MY_DB_driver extends '.config_item('subclass_prefix').'DB_driver { }');
} else 
	eval('class MY_DB_driver extends CI_DB_driver { }');
// ------------------------------------------------------------------------

/**
 * [REAL] Active Record Class
 *
 * Copy from the original Active Record Class. The different are, it extends from MY_DB_driver
 * NEEDED for the extended MY_DB_active_record class
 *
 * @package		CodeIgniter
 * @subpackage	Drivers
 * @category	Database
 ...
 */
class REAL_DB_active_record extends MY_DB_driver 
{
...
/*
	...
	{
		parent::__construct();
		log_message('debug', 'MY_DB_active_record Loaded');
	}
*/
	/**
	 * Select
