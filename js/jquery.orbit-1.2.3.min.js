...
(function(d){
    ...
    p=0,h,v,u,f=d(this).addClass("orbit"),c=f.wrap('<div class="orbit-wrapper" />').parent();
        f.add(h).width("970px").height("300px");
...
if(a.captions){
    c.append('<div class="orbit-caption orbit-bg"></div>');
    //c.append('<div class="orbit-caption" id="#htmlCaption"><p class="orbit-title">Mencari Tenaga Pengajar di Luar Sekolah?</p><p>Sudah merupakan fakta bahwa seorang pembaca akan terpengaruh oleh isi tulisan dari sebuah halaman saat ia melihat tata letaknya. Maksud penggunaan Lorem Ipsum adalah karena ia kurang lebih memiliki penyebaran huruf. Sudah merupakan fakta bahwa seorang pembaca akan terpengaruh</p></div>');
